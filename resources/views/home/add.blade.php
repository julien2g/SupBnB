...
@section('content')
    <div class="container">
<form method="post" action="{{ isset($home->slug) ? route('updateHome', ['slug' => $home->slug ]) : route('createHome')}} ">
    ...
    <div class="form-group">
        ...
        <input type="text" name="address" id="address" class="form-control" value="{{$home->address or ''}}" required>
    </div>
    <div class="form-group">
